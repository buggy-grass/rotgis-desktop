...
if (process.env.WEBPACK_SERVE) {
  const rendererConfig = {
    ...
    ignoreWarnings: [/Failed to parse source map/, /Module not found/],
    module: {
      rules: [
        {
          test: /\.tsx?$/,
    ...
    plugins: [
      ...
      new webpack.ProvidePlugin({
        import: () => {
          require("../libs/potree/exporter/OBJExporter");
          require("../libs/potree/loaders/OBJLoader");
          require("../libs/potree/loaders/MTLLoader");
        },
      }),
    ],
